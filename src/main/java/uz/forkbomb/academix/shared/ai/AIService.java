...
public class AIService {
    ...
    public String chat(String userMessage, String lessonContext) {
        String contextualPrompt = (lessonContext != null && !lessonContext.isBlank())
    ...
    public String generateExamQuestions(String topic, String subject, int count) {
        ...
        return ChatClient.builder(chatModel)
                .build()
                .prompt()
                .system("Siz ta'lim mutaxassisiiz. Faqat so'ralgan JSON formatda javob bering.")
                .user(prompt)
                .call()
                .content();
    }
    ...
    public String gradeExam(String questionsJson, String answersJson) {
        String prompt = String.format("""
                ...
                Score 0-100 oralig'ida bo'lsin.
                Feedback rag'batlantiruvchi va aniq bo'lsin.
    ...
    public String generateLessonDraft(String topic, String subject, int gradeLevel) {
        ...
        return ChatClient.builder(chatModel)
                .build()
                .prompt()
                .system("Siz tajribali o'zbek o'qituvchisiiz. O'zbek tilida professional dars matni yozing.")
                .user(prompt)
                .call()
                .content();
    }
    ...
    public String analyzeWeakTopics(String examResultsJson) {
        ...
        return ChatClient.builder(chatModel)
                .build()
                .prompt()
                .system("Siz ta'lim analitikiiz. JSON formatda aniq javob bering.")
                .user(prompt)
                .call()
                .content();
    }
    ...
    public String analyzeAtRiskStudents(String studentsJson) {
        ...
        return ChatClient.builder(chatModel)
                .build()
                .prompt()
                .system("Siz maktab psixologi va analitikisiz. JSON formatda javob bering.")
                .user(prompt)
                .call()
                .content();
    }
