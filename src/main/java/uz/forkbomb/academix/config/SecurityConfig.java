...
import uz.forkbomb.academix.security.JwtAuthFilter;
import uz.forkbomb.academix.security.RateLimitFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/teacher/**").hasAnyRole("TEACHER", "SCHOOL_ADMIN", "SUPER_ADMIN")
